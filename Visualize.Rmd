...
# Plot Readability
hist(helpful_reviews$Automated_Readability_Index,
     main = "Distribution of Helpful Review Readability")
hist(unhelpful_reviews$Automated_Readability_Index,
     main = "Distribution of Unhelpful Review Readability")
```
